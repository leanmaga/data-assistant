...
export default function TalkToDataPage() {
  return (
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-slate-900 rounded-2xl p-12 text-center border border-blue-100 dark:border-blue-900">
